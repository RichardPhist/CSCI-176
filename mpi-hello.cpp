////////////////////////////
//// MPI hello program, C++ version
////   send: string type, receive: c_str type (static char array)
////
//// Compile/run:    
//// $> mpic++ -o xxx mpi-hello.cpp
//// $> mpiexec -n 4 ./xxx   //4 is number of processes - any
//// Input: none
//// Output: A greeting from each process
////
//// Logic:  
////  Each process sends a message to process_0, which displays 
////  the messages received, as well as its own message.
//////////////////////////////
...
int main(int argc, char *argv[]) 
{
   ...
   MPI_Init(NULL, NULL); //start up MPI session
   ...
   { greeting = "Greetings from process_"+my_rank_str+" of "+comm_sz_str;
     ...
     ///using C-string (char greeting[MAX_STRING];),
